...
boost_computer = IntcodeComputer(input_prog[:], [1], "BOOST TEST", 1)
boost_computer.run_program()
print("Silver: %i" % boost_computer.get_output()[-1])

### PART 2
print("\n PART 2 START \n")
boost_computer_2 = IntcodeComputer(input_prog[:], [2], "BOOST", 1)
boost_computer_2.run_program()
print("Gold: %i" % boost_computer_2.get_output()[-1])
